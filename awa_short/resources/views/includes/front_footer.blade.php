...
<footer class="footer">
    ...
    <div class="sns_icon">
        {{-- リンクのURLをドメインに変える --}}
        <a href="https://twitter.com/share?text=ショートカットバトルしようぜ！&url=http://qlipserver01:8383"><img
                src="{{ asset('img/2021 Twitter logo - white.png') }}" alt="twitterロゴ" class="twitter_logo"></a>
